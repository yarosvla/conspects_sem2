...
\begin{Example}{Группа симметрий правильного n-угольника}{}
    ...
    Группа $D_n$ порождена двумя элементами: $D_n = <R_1, S_0>$ (поворот на $i\cdot \frac{2\pi}{n}$ радиан и осевая симметрия)
