...
\begin{Proposition}{Об иноаппроксимируемости общего TSP}{}
	Для любого $\rho \geq 1$: если существует $\rho$-приближённый полиномиальный алгоритм для задачи коммивояжёра, то существует $\rho$-приближённый полиномиальный алгоритм для задачи о гамильтоновом цикле (и, следовательно, $\mathrm{P} = \mathrm{NP}$).
\end{Proposition}
