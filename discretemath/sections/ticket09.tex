...
\begin{Corollary}{}{}
	...
	функция $\mu$ задаётся условиями
	\[
	\mu(x,x)=1 \quad \text{для всех } x \in P, \qquad \sum_{x \leq z \leq y} \mu(x,z)=0. \text{ и при }  x<y
	\]
\end{Corollary}
...
\begin{Definition}{ Арифметическая (мультипликативная) функция}{}
	...
	\emph{aрифметическая}, если для любых
...
\begin{Theorem}{Замкнутость относительно свёртки}{}
	Если $f$ и $g$~--- aрифметические функции, то $f * g$ также aрифметическая.
\end{Theorem}
